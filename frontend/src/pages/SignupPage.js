      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Please verify your email to activate your account. Check your spam folder if you don't see it.
          </p>
          <button style={{
            width: '100%',
            padding: '13px',
      ...
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <p style={{
            fontSize: '14px',
            color: '#64748b'
          }}>Join 2,400+ candidates finding their dream job</p>
        </div>
            ...
            <>
              <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input
                    type="text"
                    placeholder="Infosys BPO Indore"
